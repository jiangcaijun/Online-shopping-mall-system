    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
				...
				<li class="current-li per-li2"><a>修改密码<span>></span></a></li>
    	...
    	<div class="personal-r f-r">
        	<div class="personal-right">
                ...
                <div class="data-con">
                     <div class="dt1">
                    	<p class="dt-p f-l">旧密码：</p>
                        <input type="password" name="password" id="password" value="" /><span id="oldPw1" style=display:none>请输入密码</span><span id="oldPw2" style=display:none>旧密码错误</span>
                        <div style="clear:both;"></div>
                    </div>
                    <div class="dt1">
                        <p class="dt-p f-l">新密码：</p>
                        <input type="password" name="RePassWord1" id="RePassWord1" value="" onblur="checkPw1()"/><span id="pw1" style=display:none>请输入密码</span>
                        <div style="clear:both;"></div>
                    </div>
                    <div class="dt1">
                        <p class="dt-p f-l">确认密码：</p>
                        <input type="password" name="RePassWord2" id="RePassWord2" value="" onblur="checkPw2()"/><span id="pw2" style=display:none>两次密码不一致，请重新输入</span>
                        <div style="clear:both;"></div>
                    </div>
                    <button class="btn-pst" onclick="changePw()">保存</button>
                </div>
            </div>
        </div>
        <div style="clear:both;"></div>
