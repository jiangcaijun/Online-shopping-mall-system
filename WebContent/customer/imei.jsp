...
<link rel="stylesheet" type="text/css"
	href="/customer/css/shopping-mall-index3.css" />
...
<script type="text/javascript" src="/customer/js/imei.js"></script>
</head>
	...
	<div class="personal w1200">
		<div class="personal-left f-l">
			...
			<ul>
				...
				<li class="current-li per-li3"><a>我的设备<span>></span></a></li>
		...
		<div class="personal-r f-r">
			<div class="personal-right">
				...
				<div class="data-con">
					<div class="dt1">
						<p class="dt-p f-l">设备编码：</p>
						<input type="text" name="imei" id="imei"
							placeholder="请输入IMEI码,形如AAA20151212" /><span id="ii" style="display:none"><font size="3" color="red">请输入要绑定的设备编号</font></span>
						<div style="clear: both;"></div>
					</div>
					<button class="btn-pst" onclick="getBd()">绑定</button>
				</div>
			</div>
		</div>
		...
		<div class="purchase-records f-r">
			<div class="pr-tit">
				<P class="pr-p1">设备</P>
				<P class="pr-p55">IMEI码</P>
				<P class="pr-p55">绑定时间</P>
			</div>
			<div class="pr-info">
