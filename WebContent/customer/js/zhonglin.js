...
//轮播图 END
	...
	$("[dz-guan]").click(function(event) {
		...
		/*修改地址*/
	/*$("a[id='xiugai']").click(function(event) {
		
		$("[xgdz2]").show();
		var dz1 = $(this).siblings("h3").children('.sp1').text();  
		var dz2 = $(this).siblings("h3").children('.sp2').text(); 
		var dz3 = $(this).siblings("h3").children('.sp3').text(); 
		var dz4 = $(this).siblings("p").children('.sp1').text(); 
		var dz5 = $(this).siblings("p").children('.sp2').text(); 
