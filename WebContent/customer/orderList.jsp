...
<script type="text/javascript" src="/customer/js/orderList.js"></script>
</head>
...
<body>
	...
	<div class="personal w1200">
		<div class="personal-left f-l">
			...
			<ul>
				<ul>
					...
					<li class="current-li per-li4"><a>兑换记录<span>></span></a></li>
		...
		<div class="purchase-records f-r" id="exchangeAll">
