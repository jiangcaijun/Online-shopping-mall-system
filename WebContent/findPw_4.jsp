...
<body class="pg-retrieve theme--www">
	...
	<div class="content">
		...
		<ul class="steps-bar steps-bar--dark cf">
			<li class="step step--first" style="z-index: 3"><span
			...
			<li class="step step--last step--current" style="z-index:0"><span
		...
		<div class="retrieve-result">
			<h3 class="retrieve-result__tip">
				<i class="icon tip-status tip-status--large tip-status--large--success"></i>
				<span class="tip__title">您的登录密码已经重新设置，请妥善保管</span>
			</h3>
			<div class="form-field retrieve-result__content">
				<a class="btn" href="/login.jsp">立即登录</a>
			</div>
		</div>
	</div>
	</form>
