    ...
    function initTable() {
        ...
        $remove.click(function () {
            ...
            $.get("/user",{action:"changeState",ids:""+ids,type:"del",state:"0"},function(data){
            	if(data){
        ...
        $find.click(function () {
        	var ids = getIdSelections();
            $.get("/user",{action:"changeState",ids:""+ids,type:"del",state:"1"},function(data){
            	if(data){
            		$table.bootstrapTable('refresh');
            	}
            });  
	...
	function addOption(){
		 $("#select").append("<option value ='username'>员工姓名</option>");
