...
<head>
  ...
  <!--   <link rel="stylesheet" type="text/css" href="//s0.meituan.net/bs/css/?f=fs:fe-sso-fs/build/page/forget/index.be495f4.css"> -->
    <link rel="stylesheet" type="text/css" href="/css/jcj_findPw_1.css">
...
<body class="pg-retrieve theme--www">
    ...
    <div class="wrapper cf">
        ...
        <div class="login-block">
            <span class="tip">已有宅客微购账号？</span>
            <a class="btn btn-small login" href="/account/unitivelogin?service&#x3D;www&amp;continue&#x3D;http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken">登录</a>
        </div>
    </div>
</header>
    ...
    <li class="step step--last step--post" style="z-index:0">
        ...
        <div class="form__wrapper">
            <form class="form__content" action="/user" method="POST">
                <div class="form-field">
                    <label>账户</label>
                    <input class="f-text account" name="userid" id="userid" type="text" placeholder="用户名/邮箱" onblur="userCheck()"/><span id="userId" style="display: none" style="position:absolute; left: 850px; top: 460px;">请填写用户名或邮箱</span><font style="color:red">${message}</font>

                    <span class="tip" style="display:none;"><i class="icon"></i><span></span></span>
                </div>
                <div class="form-field captcha cf">
                    <label>验证码</label>            
					<input class="f-text account" name="identifyCode" id="identifyCode" type="text" onblur="codeCheck()"><img src="/identifycode"id="code" onclick="refresh()" /><span id="identify" style="display: none">请填写验证码</span> 
                </div>
                <div class="form-field">
