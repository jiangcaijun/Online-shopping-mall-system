	...
	<div class="sign-con w1200">
		...
		<div class="sign-ipt f-l">
			...
			<font size="5" color="red">${message} <input type="hidden" name="action" value="login"></font>
				...
				<input type="checkbox" name="autoLogin" id="autologin" value="1"  style=" width: 20px; height: 20px;"/> 	
				...
				<p>
					尚无账号？请<a href="#">注册</a><a href="/findPw_1.jsp" class="wj">忘记密码？</a>
				</p>
				<a href="javascript:void(0)" onclick="return exit()">退出(alert)</a>
			</form>
		</div>
